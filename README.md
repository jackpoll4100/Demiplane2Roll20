...
There are some ways to kind of work around this, one is that if you collapse the dice roller on each sheet after making each roll and make sure to refresh each sheet before making a new roll you shouldn't have duplicates.
